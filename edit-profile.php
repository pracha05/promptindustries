						...
						<form id="defaultForm" method="post" class="" action="add-student.php">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="">
										<input type="file" class="form-control" name="" placeholder="Enter Address" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-4 col-lg-offset-10">
									<button type="submit" class="btn" style="background-color:#FC4A1A;color:#fff;" name="signup" value="Sign up">Edit</button>
								</div>
							</div>
						</form>
